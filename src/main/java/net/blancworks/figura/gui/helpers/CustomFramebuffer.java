package net.blancworks.figura.gui.helpers;
...
public class CustomFramebuffer {
    ...
    public void drawToScreen(MatrixStack stack, int viewWidth, int viewHeight) {
        ...
        bufferBuilder.vertex(0.0D, height, 0.0D).texture(0.0F, 0).color(255, 255, 255, 255).next();
        bufferBuilder.vertex(width, height, 0.0D).texture(1, 0).color(255, 255, 255, 255).next();
        bufferBuilder.vertex(width, 0.0D, 0.0D).texture(1, 1).color(255, 255, 255, 255).next();
